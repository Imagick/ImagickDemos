...
class ImagickDraw  {
	 ...
	 * @param string|ImagickPixel $fill_pixel <p>
	 * ImagickPixel to use to set the color or a string recognised as a color by ImageMagick e.g. "rgb(50, 40, 40)", "pink". 
	 * </p>
	 * @return bool No value is returned.
	 */
     ...
     * @param string|ImagickPixel $stroke_pixel <p>
     * The stroke color, either an ImagickPixel or a string recognised as a color by ImageMagick e.g. 
     * "rgb(50, 40, 40)", "pink".
     * </p>
	 * @return bool No value is returned.
	 */
...
class ImagickPixel  {
    ...
    /**
     * Gets the quantum value of a channel of the ImagickPixel
     * @param int $colorConstant <p>
     * Which color component to get. One of the Imagick color constants e.g. \Imagick::COLOR_RED.
     * </p>
     * @return int $quantum <p>
     ...
     * Which color component to set. One of the Imagick color constants e.g. \Imagick::COLOR_RED.
     * </p>
     * @param $value <p>
     * The value to set te color component to, in the range 0 to quantumRange.
     * </p>
	 */
	public function setcolorvaluequantum ($colorConstant, $value) {}
	 ...
	 * (1.732) scaled by the quantum value (65535 for ImageMagick compiled with Q16)
	 * </p>
	 * @return bool <b>TRUE</b> on success.
	 */
